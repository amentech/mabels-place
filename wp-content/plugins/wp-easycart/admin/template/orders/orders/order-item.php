...
<div class="ec_admin_order_details_line_item" id="ec_admin_order_details_line_item_<?php echo $line_item->orderdetail_id; ?>">
    ...
    <div class="ec_admin_order_details_item_details">
        ...
        if( $line_item->optionitem_label_1 || $line_item->optionitem_name_1 ){
            ...
            echo '<div class="ec_details_option_value"> '.htmlentities( stripslashes( $line_item->optionitem_name_1 ), ENT_NOQUOTES ).'</div>';
        }
        if( $line_item->optionitem_label_2 || $line_item->optionitem_name_2 ){
            ...
            echo '<div class="ec_details_option_value"> '.htmlentities( stripslashes( $line_item->optionitem_name_2 ), ENT_NOQUOTES ).'</div>';
        }
        if( $line_item->optionitem_label_3 || $line_item->optionitem_name_3 ){
            ...
            echo '<div class="ec_details_option_value"> '.htmlentities( stripslashes( $line_item->optionitem_name_3 ), ENT_NOQUOTES ).'</div>';
        }
        if( $line_item->optionitem_label_4 || $line_item->optionitem_name_4 ){
            ...
            echo '<div class="ec_details_option_value"> '.htmlentities( stripslashes( $line_item->optionitem_name_4 ), ENT_NOQUOTES ).'</div>';
        }
        if( $line_item->optionitem_label_5 || $line_item->optionitem_name_5 ){
            ...
            echo '<div class="ec_details_option_value"> '.htmlentities( stripslashes( $line_item->optionitem_name_5 ), ENT_NOQUOTES ).'</div>';
        }
        ...
        foreach( $advanced_options as $advanced_option ){
            ...
            if( $advanced_option->option_type == 'file' )
				echo '<div class="ec_details_option_value"> <a href="' . plugins_url( '/wp-easycart-data/products/uploads/' . htmlentities( stripslashes( $advanced_option->option_value ), ENT_NOQUOTES ) ) . '" target="_blank">Download File</a></div>';
				...
				echo '<div class="ec_details_option_value"> '.htmlentities( stripslashes( $advanced_option->option_value ), ENT_NOQUOTES ).'</div>';
        }
