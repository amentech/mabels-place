<div class="ec_admin_list_line_item_fullwidth ec_admin_demo_data_line">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
        ...
        if( isset( $_GET['subpage'] ) && $_GET['subpage'] == "store-status" && isset( $_GET['ec_action'] ) && $_GET['ec_action'] == "send_test_email" ){
            ...
            $isupdate = "3";
        }else if( $_GET['ec_action'] == "fix_category_permalinks" ){
			global $wpdb;
			$count_fixed = 0;
		...
		}else if( $_GET['ec_action'] == "fix_product_permalinks" ){
			global $wpdb;
			$count_fixed = 0;
    	...
    	<?php
			...
			{
			?><div class="ec_status_subtitles"><div class="dashicons-before dashicons-warning"></div>URL fopen disabled</div><?php 
			} else {
			?><div class="ec_status_subtitles"><div class="dashicons-before dashicons-yes"></div>URL fopen enabled</div><?php
			}
