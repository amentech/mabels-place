...
<div class="ec_admin_left_nav_item<?php if( isset( $_GET['page'] ) && $_GET['page'] == "wp-easycart-rates" ){ ?> ec_admin_left_nav_selected<?php }?>">
	...
	<div class="ec_admin_left_nav_label"><a href="admin.php?page=wp-easycart-rates&subpage=coupons">Marketing<?php echo apply_filters( 'wp_easycart_admin_lock_icon', ' <span class="dashicons dashicons-lock" style="color:#FC0; float:right;"></span>' ); ?></a></div>
</div>
