<div class="ec_admin_list_line_item ec_admin_demo_data_line">
    ...
    <div class="ec_colorizer_select">Store Text Shading
        	<select name="ec_option_use_dark_bg" id="ec_option_use_dark_bg">
        	    <option value="0"<?php if( get_option( 'ec_option_use_dark_bg' ) == "0" ){?> selected="selected"<?php }?>>Dark Text (most comon choice, used on white or light backgrounds)</option>
    			<option value="1"<?php if( get_option( 'ec_option_use_dark_bg' ) == "1" ){?> selected="selected"<?php }?>>Light Text (used on black or dark backgrounds)</option>
    		</select>
