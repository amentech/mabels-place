<div class="ec_admin_list_line_item ec_admin_demo_data_line">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
        ...
        <div><input type="checkbox" name="ec_option_cache_prevent" id="ec_option_cache_prevent" value="1"<?php if( get_option('ec_option_cache_prevent') == "1" ){ echo " checked=\"checked\""; }?> /> Load Cart with Script (Prevents Caching Problems)</div>
