    ...
    <div class="ec_admin_important_numbered_list_fullwidth">
        <div class="ec_admin_list_line_item_fullwidth ec_admin_demo_data_line">
            ...
            <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
                ...
                <div class='updated error' style="margin-bottom:20px;"><p><strong>We have detected this site is using an older Standard Legacy license.  All Standard Legacy licenses will be reaching End Of Life come January 1, 2020. At that point automatic updates will no longer be available.  To continue receiving updates, you can upgrade to the Professional or Premium editions before January 1st, 2020 by accessing your account at www.wpeasycart.com.</strong></p></div><br />
                ...
                **You must login with the same WP EasyCart account you used to purchase this license for it to accurately apply credit.
                ...
                <div class="ec_admin_settings_input" style="padding:0px;">
                	<span class="ec_language_row_label">Email Address:</span>
                    <br />
                    <input type="email" name="customeremail" id="customeremail" value="<?php echo $license_info['customer_email']; ?>" >
                    <input type="submit" class="ec_admin_settings_simple_button" value="UPDATE EMAIL ADDRESS" />
                </div>
                </form>
