...
final class wp_easycart_admin_products{
	...
	public function add_inventory_notification_setting( ){
		echo '<div style="margin-top:5px;"><input type="checkbox" name="ec_option_enable_inventory_notification" id="ec_option_enable_inventory_notification" value="0" onclick="show_pro_required( );" readonly="readonly" /><span class="dashicons dashicons-lock" style="color:#FC0; margin-top:10px;"></span> Allow Customers to Subscribe to Stock Notifications</div>';
	}
