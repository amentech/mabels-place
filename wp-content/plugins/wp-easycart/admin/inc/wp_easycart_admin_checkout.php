...
class wp_easycart_admin_checkout{
	...
	public function save_checkout_form( ){
		$ec_option_load_ssl = $ec_option_cache_prevent = $ec_option_display_country_top = $ec_option_use_address2 = $ec_option_collect_user_phone = $ec_option_enable_company_name = $ec_option_collect_vat_registration_number = $ec_option_user_order_notes = $ec_option_require_terms_agreement = $ec_option_use_contact_name = $ec_option_show_card_holder_name = 0;
		if( isset( $_POST['ec_option_load_ssl'] ) && $_POST['ec_option_load_ssl'] == '1' )
			$ec_option_load_ssl = 1;
		if( isset( $_POST['ec_option_cache_prevent'] ) && $_POST['ec_option_cache_prevent'] == '1' )
