...
define( 'EC_CURRENT_VERSION', '4_2_9' );
define( 'EC_CURRENT_DB', '1_30' );/* Backwards Compatibility */
define( 'EC_UPGRADE_DB', '67' );
...
function wp_easycart_dynamic_cart_display( ){
    ...
    $error_codes = array( "email_exists", "login_failed", "3dsecure_failed", "manualbill_failed", "thirdparty_failed", "payment_failed", "card_error", "already_subscribed", "not_activated", "subscription_not_found", "user_insert_error", "subscription_added_failed", "subscription_failed", "invalid_address", "session_expired", "invalid_vat_number", "stock_invalid" );
...
function ec_ajax_get_stripe_shipping_dynamic( ){
	...
	if( count( $_POST['shippingAddress']['addressLine'] ) > 0 )
		$GLOBALS['ec_cart_data']->cart_data->shipping_address_line_1 = strip_tags( $_POST['shippingAddress']['addressLine'][0] );
	
	if( count( $_POST['shippingAddress']['addressLine'] ) > 1 )
		$GLOBALS['ec_cart_data']->cart_data->shipping_address_line_2 = strip_tags( $_POST['shippingAddress']['addressLine'][1] );
