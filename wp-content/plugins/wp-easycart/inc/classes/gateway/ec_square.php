	...
	*****************************************/
    ...
    function get_order_data( ){
        ...
        if( $this->order_totals->shipping_total > 0 ){
            ...
            $json_arr['order']['service_charges'] = array( $service_charge );
        }
	...
	function renew_token( ){
        ...
        if( $response ){
            ...
            if( isset( $response_obj->access_token ) && $response_obj->access_token ){
            ...
            if( isset( $response_obj->expires_at ) && $response_obj->expires_at ){
            ...
            if( isset( $response_obj->refresh_token ) && $response_obj->refresh_token ){
    ...
    function get_modifiers( $cursor = false ){
        $access_token = ( get_option( 'ec_option_square_is_sandbox' ) ) ? get_option( 'ec_option_square_sandbox_access_token' ) : get_option( 'ec_option_square_access_token' );
        $location_id = ( get_option( 'ec_option_square_is_sandbox' ) ) ? get_option( 'ec_option_square_sandbox_location_id' ) : get_option( 'ec_option_square_location_id' );
        if( !$location_id ){
			$location_id = $this->get_location_id( );
    ...
    function get_modifier_items( $cursor = false ){
        $access_token = ( get_option( 'ec_option_square_is_sandbox' ) ) ? get_option( 'ec_option_square_sandbox_access_token' ) : get_option( 'ec_option_square_access_token' );
        $location_id = ( get_option( 'ec_option_square_is_sandbox' ) ) ? get_option( 'ec_option_square_sandbox_location_id' ) : get_option( 'ec_option_square_location_id' );
        if( !$location_id ){
			$location_id = $this->get_location_id( );
